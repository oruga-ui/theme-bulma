<template>
  ...
  >
    ...
    <p class="content"><b>Selected:</b> {{ selected }}</p>
        ...
        <div class="block">
      <o-switch v-model="allowNew" variant="danger" root-class="is-outlined" passive-variant="warning">
        Allow new items
      </o-switch>
      <o-switch v-model="openOnFocus" variant="danger" passive-variant="warning" left-label :rounded="false">
        Open on focus
      </o-switch>
    </div>
